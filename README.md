[![Run App Amgad Ahmed](https://github.com/Amgad1123/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Amgad1123/GithubActions/actions/workflows/run-app.yaml)
...
Right now the build status badge at the top of this Readme is for the repo `kgerot/GithubActions` and we want it to be _your_ repository.
